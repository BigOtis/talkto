...
const AboutInfo = () => {
  ...
  In addition to the above terms, users of Talk To AI are solely responsible for any characters they create and the content of the conversations they engage in. Users are required to direct the conversations in a manner that is consistent with our terms of use. Talk To AI does not assume responsibility for any topics or discussions that may violate the terms of use as a result of user input or direction. By using our platform, you acknowledge that you are accountable for the conversations you initiate and the topics you choose to discuss, and you agree to abide by our terms of use.
